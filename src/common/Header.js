...
import logoImg from "../assets/footerImg/logo.png";
      ...
      <HeaderDiv>
        ...
        <ToggleButton onClick={() => setIsToggled(!isToggled)}>
          ...
          <Link to="/" className="logo" style={{ color: "white" }}>
            <img src={logoImg} alt="logo" style={{width:"200px", height:"40px"}}/>
          </Link>

          <div className="menu">
            <MenuUL isToggled={isToggled}>
              <li>
                <MenuULLiLink to="/">매장소개</MenuULLiLink>
              </li>
              <li>
                <MenuULLiLink to="/test">매장 안내</MenuULLiLink>
              </li>
              <li>
                <MenuULLiLink to="/tnrth">매장 시설</MenuULLiLink>
              </li>
              <li>
                <MenuULLiLink to="/post">결제 테스트</MenuULLiLink>
              </li>
            </MenuUL>
          </div>
          {user ? (
